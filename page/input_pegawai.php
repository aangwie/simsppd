          ...
          <div class="row">
            <div class="col-6">
              <div class="form-group">
                ...
                <input name="nama_pegawai" class="form-control" placeholder="Nama Pegawai / Pejabat" required autofocus>
              </div>
            </div>
            <div class="col-6">
              <div class="form-group">
                <label>NIP</label>
                <input name="nip_pegawai" type="number" class="form-control" placeholder="Masukkan NIP" required autofocus>
            </div>
          </div>
        </div>
          <!-- ./ Row 1-->
