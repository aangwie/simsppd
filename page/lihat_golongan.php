          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title" align="center">Tabel Data Golongan Pegawai</h3>
                <button class="btn btn-primary btn-sm float-right" onClick="location.href='dashboard.php?p=input-golongan'"><i class="fas fa-plus-square nav-icon"></i></button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      // error_reporting(E_ALL & ~E_NOTICE);
                        include "../koneksi.php";
                        $nomor=1;
                        $query_mysql = mysqli_query($konek, "SELECT * FROM golongan ORDER BY id_golongan ASC");
                    ...
                    <tr>
                      ...
                      <td align="center">
                        <a class="btn btn-primary btn-xs" href="dashboard.php?p=edit-golongan&&id_golongan=<?php echo $data['id_golongan']; ?>"><i class="fas fa-edit nav-icon"></i></a>
                        <button class="btn btn-danger btn-xs hapus" href="dashboard.php?p=hapus-golongan&&id_golongan=<?php echo $data['id_golongan']; ?>" ><i class="fas fa-trash nav-icon"></i></button>
                      </td>
                    </tr>
                      <?php } ?>
                    </tbody>
