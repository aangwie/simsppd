      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Input Data Jabatan</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
          ...
          <div class="row">
            <div class="col-6">
              <div class="form-group">
                <label>Jabatan</label>
                <input name="nama_jabatan" id="nama_jabatan" type="text" class="form-control" placeholder="Masukkan Nama Jabatan" required autofocus>
              </div>
            </div>
        </div>
          <!-- ./ Row 1-->
