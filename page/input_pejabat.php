...
<div class="container-fluid">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h2>Input Data Pejabat</h2>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active">Input Data Pejabat</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid">
      <div class="card card-primary">
        <div class="card-header">
          <h3 class="card-title">Input Data Pejabat</h3>
        ...
        <div class="card-body">
          <form action="proses-pejabat.php" method="post">
          <!-- Row 1-->
          <div class="row">
            <div class="col-6">
              <div class="form-group">
                <label>Nama Pejabat</label>
                <input name="nama_pejabat" class="form-control" placeholder="Nama Pegawai / Pejabat" required autofocus>
              </div>
            </div>
            <div class="col-6">
              <div class="form-group">
                <label>NIP</label>
                <input name="nip_pejabat" type="number" class="form-control" placeholder="Masukkan NIP" required autofocus>
            </div>
          </div>
        </div>
          <!-- ./ Row 1-->
