    ...
    <div class="container-fluid">
      <div class="card card-primary">
        <div class="card-header">
          ...
          <button class="btn btn-warning btn-sm float-right" onClick="location.href='dashboard.php?p=lihat-golongan'"><i class="fas fa-eye nav-icon"></i></button>
        </div>
        <div class="card-body">
          <form action="update-golongan.php" method="post">
          <!-- Row 1-->
          <?php 
            error_reporting(E_ALL & ~E_NOTICE);
            include "../koneksi.php"; 
            $id_gol=$_GET['id_golongan']; 
            $query_mysql=mysqli_query($konek, "SELECT * FROM golongan WHERE id_golongan='$id_gol'")or die(mysqli_error()); 
          ...
          <div class="row">
            <div class="col-6">
              <div class="form-group">
                ...
                <input name="id_golongan" type="text" class="form-control" value="<?php echo $data['id_golongan'] ?>" readonly>
              </div>
            </div>
            <div class="col-6">
              <div class="form-group">
                <label>Nama Golongan</label>
                <input name="nama_golongan" type="text" class="form-control" value="<?php echo $data['nama_golongan'] ?>" required autofocus>
              </div>
            </div>
        </div>
          <!-- ./ Row 1-->
