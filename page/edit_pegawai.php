    ...
    <div class="container-fluid">
      <div class="card card-primary">
        <div class="card-header">
          ...
          <button class="btn btn-warning btn-sm float-right" onClick="location.href='dashboard.php?p=lihat-pegawai'"><i class="fas fa-eye nav-icon"></i></button>
        </div>
        <div class="card-body">
          <form action="update-pegawai.php" method="post">
            ...
            $query_mysql=mysqli_query($konek, "SELECT * FROM pegawai WHERE id_pegawai='$id_pegawai'")or die(mysqli_error()); 
          ...
          <div class="row">
            <div class="col-4">
              <div class="form-group">
                ...
                <input type="text" name="id_pegawai" name="id_pegawai" class="form-control" value="<?php echo $data['id_pegawai']?>" readonly>
              </div>
            </div>
            <div class="col-4">
              <div class="form-group">
                <label>Nama Pegawai</label>
                <input name="nama_pegawai" class="form-control" value="<?php echo $data['nama_pegawai']?>" required autofocus>
              </div>
            </div>
            <div class="col-4">
              <div class="form-group">
                <label>NIP</label>
                <input name="nip_pegawai" type="number" class="form-control" value="<?php echo $data['nip_pegawai']?>" required autofocus>
            </div>
          </div>
        </div>
          <!-- ./ Row 1-->
                   ...
                   <select name="jabatan_pegawai" class="form-control select2" required>
                    <option selected disabled></option>
                      <?php 
                          ...
                          while($jab = mysqli_fetch_assoc($djabat))
                          {
                          ?>
                    <option><?php echo $jab['nama_jabatan']; ?></option>
                        <?php } ?>
                  </select>
              </div>
            </div>
