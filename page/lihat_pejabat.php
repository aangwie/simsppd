          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title" align="center">Tabel Data Pejabat</h3>
                <button class="btn btn-primary btn-sm float-right" onClick="location.href='dashboard.php?p=input-pejabat'"><i class="fas fa-plus-square nav-icon"></i></button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      // error_reporting(E_ALL & ~E_NOTICE);
                        include "../koneksi.php";
                        $nomor=1;
                        $query_mysql = mysqli_query($konek, "SELECT * FROM pejabat ORDER BY id_pejabat ASC");
                    ...
                    <tr>
                      ...
                      <td><?php echo $data['golongan_pegawai']; ?></td>
                      <td align="center">
                        <a class="btn btn-primary btn-xs" href="dashboard.php?p=edit-pejabat&&id_pejabat=<?php echo $data['id_pejabat']; ?>"><i class="fas fa-edit nav-icon"></i></a>
                        <button class="btn btn-danger btn-xs hapus" href="dashboard.php?p=hapus-pejabat&&id_pejabat=<?php echo $data['id_pejabat']; ?>" ><i class="fas fa-trash nav-icon"></i></button>
                      </td>
                    </tr>
                      <?php } ?>
                    </tbody>
