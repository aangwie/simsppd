...
<div class="container-fluid">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h2>Input Undangan</h2>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active">Input Undangan</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid">
      <div class="card card-success">
        <div class="card-header">
          <h3 class="card-title">Input Undangan</h3>
        ...
        <div class="card-body">
          <form action="proses-undangan.php" method="post">
          <!-- Row 1-->
          <div class="row">
            <div class="col-3">
          ...
          <div class="row">
            <div class="col-4">
              <div class="form-group">
                <label>Sifat</label>
                <input type="text" class="form-control" name="sifat" placeholder="Sifat Surat" required>
              </div>
            </div>
            <div class="col-4">
              <div class="form-group">
                <label>Lampiran</label>
                <input type="text" class="form-control" name="lampiran" placeholder="Lampiran Surat" required>
              </div>
            </div>
            <div class="col-4">
              <div class="form-group">
          ...
          <div class="row">
            <div class="col-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="asal" placeholder="Sifat Surat" required>
              </div>
            </div>
            <div class="col-4">
              <div class="form-group">
                <label>Tanggal Terbit</label>
                <input type="text" class="form-control datepicker" name="tgl_terbit" placeholder="Tanggal" required>
              </div>
            </div>
            <div class="col-4">
              <div class="form-group">
                <label>Ditujukan Untuk</label>
                <input type="text" class="form-control" name="kepada" placeholder="Perihal Surat" required>
              </div>
            </div>
          </div>
          <!-- ./ Row 3-->
          ...
          <div class="row">
            ...
            <div class="col-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control datepicker" name="tgl_acara" placeholder="Tanggal" required>
              </div>
            </div>
            <div class="col-4">
              <div class="form-group">
                <label>Waktu</label>
                <input type="text" class="form-control" name="waktu" placeholder="Misal : 08.00 WIB" required>
              </div>
            </div>
          </div>
          <!-- ./ Row 4-->
          ...
          <div class="row">
            <div class="col-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="tempat_kegiatan" placeholder="Tempat / Lokasi" required>
              </div>
            </div>
            <div class="col-8">
              <div class="form-group">
                <label>Acara</label>
                <textarea class="form-control" name="acara" placeholder="Acara" required></textarea>
              </div>
            </div>
          </div>
           <!-- ./ Row 5-->
