      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Input Data Golongan</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid">
      <div class="card card-primary">
        <div class="card-header">
          <h3 class="card-title">Input Data Golongan</h3>
          ...
          <div class="row">
            <div class="col-6">
              <div class="form-group">
                ...
                <input name="nama_golongan" id="nama_golongan" type="text" class="form-control" placeholder="Masukkan Golongan" required autofocus>
              </div>
            </div>
        </div>
          <!-- ./ Row 1-->
